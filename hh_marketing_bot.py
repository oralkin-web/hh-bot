...
SEARCH_CONFIG = {
    "query": "дизайн директор OR операционный директор дизайн OR руководитель дизайн студии OR head of design OR директор креативного департамента",
    "area": 1,
    "per_page": 50,
...
- Аутсорс-агентства (не топ-уровень)
